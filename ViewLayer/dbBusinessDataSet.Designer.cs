...
namespace ViewLayer.dbBusinessDataSetTableAdapters {
    ...
    public partial class categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[category] ([name], [description]) VALUES (@name, @description)" +
                ";\r\nSELECT idcategory, name, description FROM category WHERE (idcategory = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[category] SET [name] = @name, [description] = @description WHERE (([idcategory] = @Original_idcategory) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)));
SELECT idcategory, name, description FROM category WHERE (idcategory = @idcategory)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idcategory, name, description FROM dbo.category";
        ...
        public virtual int Fill(dbBusinessDataSet.categoryDataTable dataTable) {
        ...
        public virtual dbBusinessDataSet.categoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbBusinessDataSet.categoryDataTable dataTable = new dbBusinessDataSet.categoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbBusinessDataSet.categoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idcategory, string Original_name, string Original_description) {
        ...
        public virtual int Update(string name, string description, int Original_idcategory, string Original_name, string Original_description, int idcategory) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string description, int Original_idcategory, string Original_name, string Original_description) {
            return this.Update(name, description, Original_idcategory, Original_name, Original_description, Original_idcategory);
        }
    }
